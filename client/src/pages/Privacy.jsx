...
export default function Privacy() {
  return (
    ...
    >
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Guideline Gopher.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Guideline Gopher, accessible from{" "}
            <a
              href="=https://www.guidelinegopher.com/"
              rel="external nofollow noopener"
              target="_blank"
              style={{ color: "white" }}
            >
              https://www.guidelinegopher.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>
          <p>By email: info@guidelinegopher.com</p>
        </li>
        <li>
          <p>
